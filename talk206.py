...
WHOTO="1337haX0r@jabber.org" # Gregory Dudek's jabber.org account to talk to
...
class Talkbot206(sleekxmpp.ClientXMPP):
    ...
    # COMP206:
    # THIS FUNCTION MUST BE REMOVED (or substantially modified and renamed)
    ...
    def message(self, msg):
        ...
        # See if this is a repeated message.  We want to detect these to avoid
        # chatbots talking to one another over-and-over in a mindless loop.
        if last == msg['body']:
            print "Not answer repeated message:",last
            replied = 1000 # Repeating a lot? looping? dont reply any more to anything

        # save the last message we got to check for
        # repeats
        last = msg['body']
